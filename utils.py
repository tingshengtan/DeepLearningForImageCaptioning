...
def create_input_files(dataset, karpathy_json_path, image_folder, image_length, image_width, captions_per_image, min_word_freq, output_folder, max_len=100):
    """
    ...
    for impaths, imcaps, split in [(train_image_paths, train_image_captions, 'TRAIN'),
        ...
        with h5py.File(os.path.join(output_folder, split + '_IMAGES_' + base_filename + '.hdf5'), 'a') as h:
            ...
            images = h.create_dataset('images', (len(impaths), 3, image_length, image_width), dtype='uint8')
            ...
            for i, path in enumerate(tqdm(impaths)):
                ...
                assert img.shape == (3, image_length, image_width)
