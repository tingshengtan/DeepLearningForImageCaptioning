...
rsync -avu /home/${STUDENT_ID}/EdinburghMlpGroupProject/EdinburghMlpClusterTutorial/data/64By64/glove_words.pkl ${DATA_FOLDER}

# Activate the relevant virtual environment:
source /home/${STUDENT_ID}/miniconda3/bin/activate mlp

cd ..
python eval.py --experiment_name "image_caption_densenet_lstm_glove_64_by_64_exp" \
               --dataset_name "coco" \
               --data_name "coco_5_cap_per_img_5_min_word_freq" \
               --best_val_model_idx_for_test 15 \
               --seed 0 \
